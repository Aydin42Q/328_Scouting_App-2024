    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.HighGoalButton:
                highGoalCount = updater(highGoalCount, highGoal, "Speaker Goal: ");
                if (ampedBool == true){
            ...
            case R.id.LowGoalButton:
                lowGoalCount = updater(lowGoalCount, lowGoal, "Amp Goal: ");
                undoValue = 3;
            ...
            case R.id.UndoButton:
                if (undoValue == 1) {
                    highGoalCount = updaterMinus(highGoalCount, highGoal, "Speaker Goal: ");
                    totalPoints = totalPoints - 5;
                    teleOpPoints = teleOpPoints - 5;
                    totalCount = totalCount - 1;
                    MainActivity.setTotalCount(totalCount);
                    ...
                    lowGoalCount = updaterMinus(lowGoalCount, lowGoal, "Amp Goal: ");
                    totalPoints = totalPoints - 2;
                    teleOpPoints = teleOpPoints - 2;
                    totalCount = totalCount - 1;
                    MainActivity.setTotalCount(totalCount);
